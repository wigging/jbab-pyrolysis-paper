...
\subsection{Fluidizing gas effect on pyrolysis performance with constant $U/U_{mf}$}



\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/cfd-constuumf-rtd-avg.png}
    \caption{Average particle residence time as a function of H$_2$ mass fraction in fluidizing gas at constant $U/U_{mf}$.}
    \label{fig:cfd-rtd_avg}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/cfd-constuumf-particle-temp-density.png}
    \caption{Average particle temperature (left) and density (right) as a function of time in reactor for varying H$_2$ mass fraction at constant $U/U_{mf}$.}
    \label{fig:cfd-constuumf-particle-temp-density}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/cfd-constuumf-reaction-rates.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/cfd-constuumf-yields.png}
