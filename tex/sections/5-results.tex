...
\subsection{Validating gas mixture viscosity}

Comparisons of the calculated gas mixture viscosity to literature data are shown in Figures \ref{fig:gas-h2n2-data} and \ref{fig:gas-h2o2-data}. The Herning and Zipperer equation provided the best match to experimental measurements for both the H$_2$/N$_2$ and H$_2$/O$_2$ mixtures.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/gas-h2n2-data.pdf}
    \caption{Calculated (lines) and measured (symbols) gas viscosity for a H$_2$/N$_2$ mixture.}
    \label{fig:gas-h2n2-data}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/gas-h2o2-data.pdf}
    \caption{Calculated (lines) and measured (symbols) gas viscosity for a H$_2$/O$_2$ mixture.}
    \label{fig:gas-h2o2-data}
\end{figure}
