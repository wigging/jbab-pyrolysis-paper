...
\begin{figure}[H]
    ...
    \caption{Heterogeneous reaction rate profiles inside the reactor as affected by different fluidizing gas at a constant velocity. (a) Biomass pyrolysis reaction rate profile, (b) Biomass tarring reaction rate profile, (c) CO$_2$–char gasification reaction rate profile, and (d) Steam–char gasification reaction rate profile. The reactor height (0.43 m) is denoted by the letter H.}
