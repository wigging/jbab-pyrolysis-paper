...
% No results are provided for cases with 20% each of N2, H2, CO, CO2 and CH4 and the case with 50% H2O and CO, so they have
% been removed from the table

% Updated caption to specify that it is in terms of volume percentage
